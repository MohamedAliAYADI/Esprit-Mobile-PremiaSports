 ...
 * @author user
 */
public class AjoutPanier extends Container {

    public AjoutPanier(Resources theme, Produits p) {
...
Container ctquantite = new Container();
  ...
  ctquantite.addAll(labquantite,lab5);
      ...
      this.addAll(ctnimg,ctn,ctprix,ctref,ctquantite);
        ...
        Button btn1 = new Button("Ajouter dans Mon panier ");
        btn1.addActionListener((evt) -> {

            Dialog.show("vous voulez ajouter le produit dans votre panier ", "appu sur oui ken oui", "oui", null);
